        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-accent/10 p-6 rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">JNTU Anantapur</p>
            </div>
            <div className="bg-accent/10 p-6 rounded-lg">
              <h3 className="font-semibold mb-4">Experience</h3>
              <p>Software Developer</p>
              <p className="text-sm text-muted-foreground">Genamplifiy Solution Hub Private Limited, Hyderabad</p>
            </div>
          </div>
        </motion.div>
      </div>
